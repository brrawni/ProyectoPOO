...
│   ├── launcher/                  // Plataforma principal
│   │   ├── Launcher.java
│   │   ├── PanelLauncher.java
│   │   └── Boton.java
│   ├── motor/                     // Clases base compartidas
│   │   ├── Entidad.java
│   │   ├── Jugador.java
│   │   ├── Enemigo.java
│   │   ├── Proyectil.java
│   │   ├── Videojuego.java
│   │   └── GestorConfiguracionBase.java
│   ├── spaceinvaders/             // Juego Space Invaders
│   ├── LodeRunner/                // Juego Lode Runner
│   ├── Pong/                      // Juego Pong
│   └── ranking/                   // Sistema de ranking compartido
│       ├── GestorRanking.java
│       └── EntradaRanking.java
└── resources/
    ├── img/
    │   └── spaceinvaders/         // Sprites de Space Invaders
    └── sonido/
        ├── spaceinvaders/         // Música y efectos de Space Invaders
        ├── loderunner/            // Música y efectos de Lode Runner
        └── pong/                  // Música y efectos de Pong
```
